...
import com.nivel2.controller.addProdMenu.CreateDecorationController;
import com.nivel2.controller.addProdMenu.CreateFlowerController;
import com.nivel2.controller.addProdMenu.CreateTreeController;
import com.nivel2.controller.mainMenu.ChooseFloristController;
import com.nivel2.view.Menu;
import com.nivel2.view.addProdMenu.CreateDecorationCommand;
import com.nivel2.view.addProdMenu.CreateFlowerCommand;
import com.nivel2.view.addProdMenu.CreateTreeCommand;
...
public class FloristMenuController extends Controller{
	...
	private ChooseStockController showProductsController;
	private ChooseStockCommand showProductsCommand;
	...
	public FloristMenuController(Session session) {
		...
		this.showProductsController = new ChooseStockController(this.session);
		this.showProductsCommand = new ChooseStockCommand();
